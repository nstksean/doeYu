    ...
    scenicSpotAPI_data: [
        {
            ...
            Description:
                '又名崇德居，建於八十幾年前，是三重唯一保存完整的古厝。紅牆紅瓦的三合院落，雖置身鬧市裡，卻有恬靜安然的氣息，那種舊時的生活痕跡，溫暖許多人的記憶，屋頂簷樑間的剪黏和厝身的水車堵，出自名師陳天乞之手，大廳則是由建造先嗇宮的師傅群完成，氣派莊嚴，極具觀賞價值，若幸運得遇主人，可詢問是否可以入內參觀。',
            ...
            Picture: {
                PictureUrl1:
                    'https://newtaipei.travel/content/images/attractions/1663/640x480_1249a970109000004969.jpg',
        ...
        },
        {
            ...
            ZipCode: '241',
            TravelInfo:
                '＊捷運：搭乘捷運蘆洲線至捷運徐匯中學站，步行至碧華街約5分鐘。＊公車： 1.台北客運：229(保佑村-萬華車站)、264(板橋-蘆洲) 2.大都會客運：306(舊庒-蘆洲) 3.三重客運：221(蘆洲-台北車站)、225(蘆洲-民生社區)4.232(蘆洲-松山車站)、306(淩雲五村-蘆洲)、508黃(蘆洲-惇敘高中)、508正線(惇敘高中-蘆洲)、659(蘆洲-台北車站) 、...',
            OpenTime: '全年開放，以店家時間為準',
            Picture: {
                PictureUrl1:
                    'https://newtaipei.travel/content/images/attractions/1669/640x480_20130830095936.jpg',
        ...
        },
        {
            ...
            ZipCode: '241',
            TravelInfo:
                '【大眾運輸】搭乘捷運至台北橋站下車，往中央北路方向步行約3分鐘。',
            OpenTime: '17:00~24:00(以店家營業時間為準)',
            Picture: {
                PictureUrl1:
                    'https://newtaipei.travel/content/images/attractions/43605/640x480_attractions-image-a9z3oxs1qey0oxu96jbx2q.jpg',
        ...
        },
        {
            ...
            DescriptionDetail:
                '從車潮川流的正義南路探進86巷，映入眼簾的，是兩支青天白日滿地紅國旗，低矮樸素的磚房延道排列，充滿懷舊記憶的「空軍三重一村」就在這裡。「空軍三重一村」，於2006年8月登錄為新北市歷史建築，是目前新北市的眷村文化資產。1954年，婦聯會在此興建空軍眷舍，房子的格局與大小，依軍階大小遞減建造，日軍、國軍部隊都曾在此駐紮，村裡的兩座大型地底防空洞至今保存完整，面積約兩個籃球場大；還有日治時代遺留下來的砲陣地。',
            Description: '懷舊氛圍沿著磚房延展，守護著新北的眷村記憶',
            Phone: '886-2-89535332',
            Address: '新北市241三重區正義南路86巷',
            ZipCode: '241',
            TravelInfo:
                '【大眾運輸】搭乘捷運於「台北橋站」下車，往正義南路方向步行約10分鐘。',
            OpenTime: '10:00 - 18:00',
            Picture: {
                PictureUrl1:
                    'https://newtaipei.travel/content/images/attractions/43259/640x480_attractions-image-dsh2uuarruo-hg4np4tq3q.jpg',
